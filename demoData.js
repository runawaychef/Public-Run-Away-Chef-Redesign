...
// правами (показать разницу ролей), ~50 заказов, размазанных от -5 месяцев до
...
function demoOrderPlan() {
    const plan = [];
    const monthlyCounts = [4, 6, 8, 10, 13]; // от самого дальнего к ближнему завершённому месяцу
